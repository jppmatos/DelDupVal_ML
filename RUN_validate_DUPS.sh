...
#input_TP_4=./test_sample/duplications_SAMPLE.csv
input_TP_4=$1

#$2='./test_sample/'
outputf=$2'output_duplications/'
mkdir $outputf
#output_path_TP_4=./test_sample/output_duplications/ 
...
python makedataset.py $output_path_TP_4 $output_path_TP_4 
