...
#input and output:
inputf_path = argv[1] # "./output/deletions/"
output_path = argv[2] # "./output/deletions/deletions_"
...
##Recombination rate: (just in deletions)
df_recombRate = pd.read_csv(inputf_path + 'RecombinationRate_regionsAB.csv', sep="\;" ,header=0)
...
df_main = pd.concat([
	...
	df_recombRate.set_index('CNV_ID').A_decodeAvg,df_recombRate.set_index('CNV_ID').B_decodeAvg,
