...
12. **CpG Islands** (CpG_island2.py): The distance and overlap with CpG islands (CpGIs) were calculated as described in 2 - RRegions with the [UCSC genome browser’s CpG islands track](http://genome.ucsc.edu/cgi-bin/hgTrackUi?hgsid=1061596481_5AATrBam7ZLtUehsvZmGAPZrucwZ&g=cpgIslandExt) (Gardiner-Garden & Frommer, 1987).
