...
###file_name = 'refined_data_DELS_Talkowski-autoSK.csv'

file_name = 'DELS_12_04/liGS_12-04-refined_data_DELS-autoSK_train.csv'

df_main = pd.read_csv(path + file_name,sep=';')
#Make directory instructions:
directory_name = "DELS_Talkowski_4hour-22-04_balanced"#_noSize" #name of output folder!
storage_folder='/'+ directory_name

#Do datasampling? (pseudo_sampling): (20% extra)
pbalancing_switch = False #!!!!!!!!!!!!!!!s
